...
export default { path: 'demo', component: require('cloud-ui.kubevue/src/layouts/l-wrapper.vue').default, children: [
    ...
    { path: 'list', component: require('cloud-ui.kubevue/src/layouts/l-wrapper.vue').default, children: [
        ...
        /* 'list/tabs' */
        { path: 'tabs', component: require('cloud-ui.kubevue/src/layouts/l-wrapper.vue').default, meta: {title:'列表页',crumb:{title:'列表页'}}, children: [
            { path: '', redirect: 'basic' },
            /* 'list/tabs/basic' */
    ...
    /* 'form' */
    { path: 'form', component: require('cloud-ui.kubevue/src/layouts/l-wrapper.vue').default, meta: {title:'表单',crumb:'表单'}, children: [
        { path: '', redirect: 'basic' },
        /* 'form/basic' */
    ...
    /* 'router' */
    { path: 'router', component: require('cloud-ui.kubevue/src/layouts/l-wrapper.vue').default, meta: {title:'路由',crumb:'路由',locks:[{include:[/router/],params:['search','demo.router.list.page']}]}, children: [
        { path: '', redirect: 'list' },
        /* 'router/list' */
